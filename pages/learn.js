      ...
      <section className="text-gray-600 body-font min-h-screen">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-4xl text-2xl font-medium title-font mb-4 text-gray-900">Learn The red</h1>
          ...
          <div className="flex flex-wrap -m-4 text-center justify-center">
            <Link href={'/markettrends'}  >
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full no-underline cursor-pointer">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  <div className='ml-0'><EqualizerIcon className='text-6xl text-red-500 mr-0' /></div>
            ...
            <Link href={"/cropplan"}>
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full no-underline cursor-pointer">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  <div className='ml-32'><TbPlant2 className='text-6xl text-red-500 mr-0' /></div>

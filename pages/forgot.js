    ...
    <div>
      ...
      <div className="flex min-h-screen items-start justify-center pt-28 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <img className="md:ml-28 h-20 w-auto ml-16" src="/logo.png" alt="PC Geeks" />
            ...
            <form className="mt-8 space-y-6" action="#" method="POST">
              ...
              <div className="-space-y-px rounded-md shadow-sm">
                ...
                <div>
                  ...
                  <input value={cpassword} onChange={handleChange} id="cpassword" name="cpassword" type="password" autoComplete="cpassword" required className="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-red-500 focus:outline-none focus:ring-red-500 sm:text-sm" placeholder="Confirm New Password" />
                </div>
              </div>

              <div>
                <button onClick={resetPassword} type="submit" className="group relative flex w-full justify-center rounded-md border border-transparent bg-red-600 py-2 px-4 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
              ...
              {password && password == cpassword && <span className='text-red-600 '>Passwords match</span>}
            </form>
          ...
          {!router.query.token && <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div>
              <button onClick={sendResetEmail} type="submit" className="group relative flex w-full justify-center rounded-md border border-transparent bg-red-600 py-2 px-4 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                <span className="absolute inset-y-0 left-0 flex items-center pl-3">

      ...
      <div>
        ...
        <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false}>
            ...
            {/* <div className="flex bg-no-repeat bg-cover bg-center  h-screen  opacity-90 text-center items-center justify-center flex-col">
              <div className='md:text-6xl text-3xl text-red-900 font-semibold font-serif '></div>
              <div className='md:text-4xl text-2xl mb-28 text-red-700 font-semibold font-serif'></div>
              </div> */}
        </section>
        ...
        <section className="text-white-600 body-font bg-bgcolor">
          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
              ...
              <p className="lg:w-1/2 w-full leading-relaxed text-white text-xl">Adding red To Life</p>
            </div>

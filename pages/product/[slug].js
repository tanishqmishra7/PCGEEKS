      ...
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">PC Geeks</h2>
            ...
            <div className='my-5 p-2'>
              <a href={product.Alink}><span className='border-solid border rounded border-black p-3 m-3'>Amazon: ₹{product.Aprice}</span></a>
              <a href={product.Flink}><span className='border-solid border rounded border-black p-3 m-3'>Flipkart: ₹{product.Fprice}</span></a>
            </div>
